...
function get_images() {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      await page.waitForSelector("body > div.mainHd > div");
      ...
      await page.waitForSelector('iframe[src^="stuerrorbook"]');
      ...
      while (!btn_avail) {
        ...
        bodyHTML = await page.evaluate(() => document.body.outerHTML);
        ...
        imgs = await $("li.list-item").each((index, ele) => {
